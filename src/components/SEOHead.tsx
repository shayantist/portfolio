...
const globalMeta = {
  ...
  description:
    "Hi, I'm Shayan! I'm a student & researcher at Columbia University, founder of the tech nonprofit Reach4Help, and a climate policy leader with Al Gore's Climate Reality Project dedicated to making the world a more equitable place through machine learning and human resilience. For my work, I've been honored to be invited to speak at Google, the UN Headquarters, the International Youth Conference, and events hosted by the World Economic Forum. Come and drop by!",
};
