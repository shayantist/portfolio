export const work = {
  title: "Hi, I'm Shayan",
  description: [
    "**Student & Researcher** @ [**Columbia University**](https://scholar.google.com/citations?user=upxVTlMAAAAJ)",
...
export const about = {
  ...
  description:
    "***\"No one is useless in this world who lightens the burdens of another.\"*** -Charles Dickens  \nThis quote speaks volumes to me. No matter how small, any positive impact you can have on someone or something's life **today** makes the world a better place than it was **yesterday**. That's what gets me out of bed every morning. Even if I can make one person's day better, it makes every doubt, every fear and every struggle all worth it.  \nOutside of work, I'm a **CS student** at **Columbia University** in New York. Recently, I've also gotten the chance to **travel** around, from **Scotland** to **San Diego**, and have been *trying* to post about my experiences on [Instagram](https://www.instagram.com/shayan.tist/) so feel free to check that out if interested!  \nWhile I'm not juggling being a student, the head of an NGO and a researcher, I love playing guitar, [browsing Reddit](https://redd.it/hp9wwp) and sleeping.",
  contact_section: {
